...
const Banner = ({query,handleInputChange,handleSubmit,handleSearch}) => {
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-8 py-14 '>
        <h1 className='text-5xl font-bold text-primary mb-3  mt-0 '>Find your <span className='text-blue'>new job </span>today</h1>
        ...
        <form onSubmit={handleSubmit}>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                <div className='flex md:rounded-s-md rounded shadow-sm ring-1 rinf-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-6600 md:w-1/2 w-full'>
